...
- Maintain the project’s standalone reference on composition over inheritance and behavior assembly.

# Ownership

- `Composition over Inheritance.md` owns the comprehensive chapter, including limits, review guidance, and sources.
