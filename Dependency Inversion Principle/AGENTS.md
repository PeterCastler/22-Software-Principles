...
- Maintain the project’s standalone reference on the Dependency Inversion Principle and policy-owned boundaries.

# Ownership

- `Dependency Inversion Principle.md` owns the comprehensive chapter, including limits, review guidance, and sources.
