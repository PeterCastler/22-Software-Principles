...
- Maintain the project’s standalone reference on DRY and the ownership of duplicated knowledge.

# Ownership

- `DRY.md` owns the comprehensive chapter, including limits, review guidance, and sources.
