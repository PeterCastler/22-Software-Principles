...
- Maintain the project’s standalone reference on replacement of custom machinery with trusted primitives.

# Ownership

- `Refactoring Toward Primitives.md` owns the comprehensive chapter, including limits, review guidance, and sources.
