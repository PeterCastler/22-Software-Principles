...
- Maintain the project’s standalone reference on the Boy Scout Rule and bounded incremental cleanup.

# Ownership

- `Boy Scout Rule.md` owns the comprehensive chapter, including limits, review guidance, and sources.
