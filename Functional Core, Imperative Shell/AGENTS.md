...
- Maintain the project’s standalone reference on functional-core/imperative-shell boundaries.

# Ownership

- `Functional Core, Imperative Shell.md` owns the comprehensive chapter, including limits, review guidance, and sources.
