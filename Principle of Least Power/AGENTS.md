...
- Maintain the project’s standalone reference on the Principle of Least Power and minimally expressive mechanisms.

# Ownership

- `Principle of Least Power.md` owns the comprehensive chapter, including limits, review guidance, and sources.
