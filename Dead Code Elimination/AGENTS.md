...
- Maintain the project’s standalone reference on dead code elimination and evidence-backed removal.

# Ownership

- `Dead Code Elimination.md` owns the comprehensive chapter, including limits, review guidance, and sources.
