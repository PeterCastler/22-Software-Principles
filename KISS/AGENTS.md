...
- Maintain the project’s standalone reference on KISS and minimum justified complexity.

# Ownership

- `KISS.md` owns the comprehensive chapter, including limits, review guidance, and sources.
