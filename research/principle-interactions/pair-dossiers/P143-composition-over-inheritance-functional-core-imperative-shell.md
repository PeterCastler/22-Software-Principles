# Composition over Inheritance ↔ Functional Core, Imperative Shell
...
Both affect assembly of pure decisions with effectful execution.

## Interaction mechanism

The screened hypothesis was: The shell composes a deterministic core with focused effect adapters instead of inheriting workflow behavior from a base class. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** The shell composes a deterministic core with focused effect adapters instead of inheriting workflow behavior from a base class.
...
Blind primary screen: **Independence / reject**. Blind independent screen: **Enablement / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
