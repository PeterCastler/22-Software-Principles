# Functional Core, Imperative Shell ↔ Data-Driven Design
...
Both affect representation and execution of deterministic decision rules.

## Interaction mechanism

The screened hypothesis was: A typed case table and small interpreter can live in the pure core, while the shell supplies and persists external data. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A typed case table and small interpreter can live in the pure core, while the shell supplies and persists external data.
