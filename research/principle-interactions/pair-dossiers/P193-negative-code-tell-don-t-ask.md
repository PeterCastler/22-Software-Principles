...
Both affect removal of duplicated query-decide-mutate sequences.

## Interaction mechanism

The screened hypothesis was: One state-owner operation can replace several caller implementations and expose a smaller mutation surface. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** One state-owner operation can replace several caller implementations and expose a smaller mutation surface.
