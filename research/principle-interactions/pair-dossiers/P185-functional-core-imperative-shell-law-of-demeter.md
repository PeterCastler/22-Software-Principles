# Functional Core, Imperative Shell ↔ Law of Demeter
...
Both affect knowledge the policy core has of infrastructure structure.

## Interaction mechanism

The screened hypothesis was: Passing explicit values and intended actions prevents core policy from navigating databases, clients, or service graphs. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Passing explicit values and intended actions prevents core policy from navigating databases, clients, or service graphs.
