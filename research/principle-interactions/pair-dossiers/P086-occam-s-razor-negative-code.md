...
Both affect removal of unsupported design entities.

## Interaction mechanism

The screened hypothesis was: Once evidence shows machinery is unnecessary to the contract, Negative Code removes the entities Occam would not posit. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Once evidence shows machinery is unnecessary to the contract, Negative Code removes the entities Occam would not posit.
