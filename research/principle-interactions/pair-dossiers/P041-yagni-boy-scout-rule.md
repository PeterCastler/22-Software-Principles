...
Both affect scope of optional work performed during a real task.

## Interaction mechanism

The screened hypothesis was: Both require a current task boundary; YAGNI excludes unrelated future-proofing from incidental cleanup. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Both require a current task boundary; YAGNI excludes unrelated future-proofing from incidental cleanup.
