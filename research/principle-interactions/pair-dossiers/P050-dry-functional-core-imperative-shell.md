# DRY ↔ Functional Core, Imperative Shell
...
Both affect placement of repeated business policy.

## Interaction mechanism

The screened hypothesis was: Moving deterministic decisions into one core gives shells a single callable authority instead of reimplementing policy around I/O. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Moving deterministic decisions into one core gives shells a single callable authority instead of reimplementing policy around I/O.
