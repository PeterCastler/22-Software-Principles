# Occam's Razor ↔ Parse, Don't Validate
...
Both affect treatment of assumptions about untrusted input.

## Interaction mechanism

The screened hypothesis was: Parsing replaces downstream unsupported assumptions with an explicit proof carried by a precise value. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Parsing replaces downstream unsupported assumptions with an explicit proof carried by a precise value.
