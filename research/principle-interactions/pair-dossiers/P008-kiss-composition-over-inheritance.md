...
Both affect mechanism used for reuse or variation.

## Interaction mechanism

The screened hypothesis was: KISS compares direct code, composition wiring, and inheritance against the actual variation instead of automatically adding collaborators. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** KISS compares direct code, composition wiring, and inheritance against the actual variation instead of automatically adding collaborators.
