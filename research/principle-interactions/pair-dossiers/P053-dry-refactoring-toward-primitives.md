# DRY ↔ Refactoring Toward Primitives
...
Both affect authority for behavior already supplied by a platform.

## Interaction mechanism

The screened hypothesis was: A contract-equivalent primitive replaces a local competing implementation, making the maintained platform capability the implementation authority. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A contract-equivalent primitive replaces a local competing implementation, making the maintained platform capability the implementation authority.
