...
Both affect reuse of existing focused components instead of custom monoliths.

## Interaction mechanism

The screened hypothesis was: Combining an existing tool through a stable interface can replace owned implementation and its perimeter. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Combining an existing tool through a stable interface can replace owned implementation and its perimeter.
