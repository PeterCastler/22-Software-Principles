...
Both affect removal of competing representations after choosing an authority.

## Interaction mechanism

The screened hypothesis was: Once DRY identifies the authoritative representation, safe deletion removes obsolete copies and their synchronization glue. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Once DRY identifies the authoritative representation, safe deletion removes obsolete copies and their synchronization glue.
