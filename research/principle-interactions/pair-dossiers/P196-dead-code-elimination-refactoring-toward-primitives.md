# Dead Code Elimination ↔ Refactoring Toward Primitives
...
Both affect cleanup after a primitive replacement.

## Interaction mechanism

The screened hypothesis was: Once calls move to the contract-equivalent primitive, liveness analysis can identify the old custom implementation and perimeter as unused. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Once calls move to the contract-equivalent primitive, liveness analysis can identify the old custom implementation and perimeter as unused.
