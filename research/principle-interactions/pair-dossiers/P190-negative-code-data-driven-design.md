# Negative Code ↔ Data-Driven Design
...
Both affect replacement of repeated control-flow implementations.

## Interaction mechanism

The screened hypothesis was: A typed table plus one algorithm can make repeated branches and case-specific implementations removable. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A typed table plus one algorithm can make repeated branches and case-specific implementations removable.
