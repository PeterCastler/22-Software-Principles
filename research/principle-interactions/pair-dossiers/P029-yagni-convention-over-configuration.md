# YAGNI ↔ Convention over Configuration
...
Causally connected decisions: YAGNI governs timing of capability and extensibility; Convention over Configuration governs routine defaults versus explicit exceptions.

## Interaction mechanism

The screened hypothesis was: Rejected hypothesis: A convention serves the current dominant case without adding knobs for exceptions that do not yet exist. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
Known tenant-specific retention rules are real exceptions and must remain explicit.

## Worked example

**Candidate hypothesis:** A convention serves the current dominant case without adding knobs for exceptions that do not yet exist.

**Observed boundary:** Known tenant-specific retention rules are real exceptions and must remain explicit.
...
Blind primary screen: **Reinforcement / uncertain**. Blind independent screen: **Moderation / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
