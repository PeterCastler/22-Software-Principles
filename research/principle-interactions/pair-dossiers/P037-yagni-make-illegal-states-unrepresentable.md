# YAGNI ↔ Make Illegal States Unrepresentable
...
Both affect which invariants deserve representation machinery now.

## Interaction mechanism

The screened hypothesis was: YAGNI limits type structure to current stable invariants rather than encoding hypothetical future workflow states. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** YAGNI limits type structure to current stable invariants rather than encoding hypothetical future workflow states.
