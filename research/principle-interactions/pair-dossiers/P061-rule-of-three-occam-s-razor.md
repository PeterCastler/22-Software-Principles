...
Both affect evidence required before introducing an abstraction entity.

## Interaction mechanism

The screened hypothesis was: Concrete cases expose supported commonality; until then Occam treats the generalized concept as an unsupported assumption. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Concrete cases expose supported commonality; until then Occam treats the generalized concept as an unsupported assumption.
