# Principle of Least Power ↔ Dependency Inversion Principle
...
Both affect expressiveness of a policy-owned contract.

## Interaction mechanism

The screened hypothesis was: A narrow domain-shaped port exposes only capabilities policy requires rather than a powerful vendor API. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A narrow domain-shaped port exposes only capabilities policy requires rather than a powerful vendor API.
