# Functional Core, Imperative Shell ↔ Tell, Don't Ask
...
Both affect placement of an invariant operation and its effects.

## Interaction mechanism

The screened hypothesis was: A domain operation can decide a transition in the core, while the shell loads state and executes persistence or messages. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A domain operation can decide a transition in the core, while the shell loads state and executes persistence or messages.
