...
Both affect component granularity and interface count.

## Interaction mechanism

The screened hypothesis was: KISS stops focused-tool decomposition when process, protocol, and failure-coordination costs exceed the complexity removed from a monolith. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** KISS stops focused-tool decomposition when process, protocol, and failure-coordination costs exceed the complexity removed from a monolith.
