...
Both affect when callers reveal a stable domain command.

## Interaction mechanism

The screened hypothesis was: Repeated query-decide-mutate sequences expose the invariant and outcome needed from the owner. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Repeated query-decide-mutate sequences expose the invariant and outcome needed from the owner.
