...
Both affect when temporary duplication can be replaced and removed.

## Interaction mechanism

The screened hypothesis was: After cases reveal a stable concept, extraction permits safe removal of duplicated implementation and glue. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** After cases reveal a stable concept, extraction permits safe removal of duplicated implementation and glue.
