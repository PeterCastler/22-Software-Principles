# YAGNI ↔ Single Responsibility Principle
...
Both affect whether predicted actors justify splitting a module.

## Interaction mechanism

The screened hypothesis was: YAGNI rejects responsibility splits based only on hypothetical stakeholders; SRP proceeds when current independent actors and reasons are identifiable. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** YAGNI rejects responsibility splits based only on hypothetical stakeholders; SRP proceeds when current independent actors and reasons are identifiable.
