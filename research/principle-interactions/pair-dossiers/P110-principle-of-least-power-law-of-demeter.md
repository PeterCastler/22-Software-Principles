# Principle of Least Power ↔ Law of Demeter
...
Both affect breadth of a collaborator interface.

## Interaction mechanism

The screened hypothesis was: Least Power limits what an immediate interface can do; Demeter limits which internal relationships the caller can reach through it. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Least Power limits what an immediate interface can do; Demeter limits which internal relationships the caller can reach through it.
