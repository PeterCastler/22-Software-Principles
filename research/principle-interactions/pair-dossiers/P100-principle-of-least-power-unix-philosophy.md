# Principle of Least Power ↔ Unix Philosophy
...
Both affect expressiveness of component interfaces.

## Interaction mechanism

The screened hypothesis was: Constrained composable values or standard streams expose less arbitrary behavior than embedding callers or scripts in each component. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Constrained composable values or standard streams expose less arbitrary behavior than embedding callers or scripts in each component.
