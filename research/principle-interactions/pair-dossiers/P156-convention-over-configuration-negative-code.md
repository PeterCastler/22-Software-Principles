# Convention over Configuration ↔ Negative Code
...
Both affect removal of redundant ordinary-case configuration.

## Interaction mechanism

The screened hypothesis was: Once a stable discoverable convention supplies the default, duplicate settings and discovery glue can be safely deleted. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Once a stable discoverable convention supplies the default, duplicate settings and discovery glue can be safely deleted.
