...
Both affect whether decomposition is justified by current composition needs.

## Interaction mechanism

The screened hypothesis was: YAGNI rejects splitting a cohesive tool solely for hypothetical reuse or pipeline consumers. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** YAGNI rejects splitting a cohesive tool solely for hypothetical reuse or pipeline consumers.
