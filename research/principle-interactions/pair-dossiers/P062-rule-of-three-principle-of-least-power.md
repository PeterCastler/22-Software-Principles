# Rule of Three ↔ Principle of Least Power
...
Both affect selection of an abstraction's expressive mechanism.

## Interaction mechanism

The screened hypothesis was: Observed cases reveal the operations and variation the extracted mechanism must express, allowing selection of the least power that actually suffices. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Observed cases reveal the operations and variation the extracted mechanism must express, allowing selection of the least power that actually suffices.
...
Blind primary screen: **Independence / reject**. Blind independent screen: **Sequencing / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
