# Composition over Inheritance ↔ Data-Driven Design
...
Both affect representation of variation.

## Interaction mechanism

The screened hypothesis was: Regular cases can move to a typed table, while irregular behavior may remain composed collaborators; each avoids forcing the other mechanism beyond its fit. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Regular cases can move to a typed table, while irregular behavior may remain composed collaborators; each avoids forcing the other mechanism beyond its fit.
...
Blind primary screen: **Independence / reject**. Blind independent screen: **Tension / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
