# Refactoring Toward Primitives ↔ Boy Scout Rule
...
Both affect scope and timing of a local primitive substitution.

## Interaction mechanism

The screened hypothesis was: Boy Scout scope limits replacement to a touched, well-characterized slice; primitive comparison supplies the concrete cleanup. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Boy Scout scope limits replacement to a touched, well-characterized slice; primitive comparison supplies the concrete cleanup.
