# Dependency Inversion Principle ↔ Tell, Don't Ask
...
Both affect capability exposed to stable policy.

## Interaction mechanism

The screened hypothesis was: A domain-shaped port or aggregate command lets policy request a meaningful operation instead of querying detail state and reconstructing its rules. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A domain-shaped port or aggregate command lets policy request a meaningful operation instead of querying detail state and reconstructing its rules.
...
Blind primary screen: **Independence / reject**. Blind independent screen: **Reinforcement / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
