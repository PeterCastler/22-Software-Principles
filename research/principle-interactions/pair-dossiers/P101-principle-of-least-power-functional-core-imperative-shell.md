# Principle of Least Power ↔ Functional Core, Imperative Shell
...
Both affect where effectful expressive power is permitted.

## Interaction mechanism

The screened hypothesis was: The shell confines I/O and mutation while the core uses value-to-value logic, limiting powerful effects to the boundary that requires them. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** The shell confines I/O and mutation while the core uses value-to-value logic, limiting powerful effects to the boundary that requires them.
