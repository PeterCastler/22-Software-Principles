# Unix Philosophy ↔ Dependency Inversion Principle
...
Both affect stable interfaces between focused policy and details.

## Interaction mechanism

The screened hypothesis was: A simple composable interface can serve as the policy-owned boundary, with external tools or adapters supplying details. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** A simple composable interface can serve as the policy-owned boundary, with external tools or adapters supplying details.
