# Principle of Least Power ↔ Convention over Configuration
...
Both affect representation of routine choices and exceptions.

## Interaction mechanism

The screened hypothesis was: Convention eliminates a mechanism for the dominant case; the remaining override can use the least expressive representation that suffices. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Convention eliminates a mechanism for the dominant case; the remaining override can use the least expressive representation that suffices.
