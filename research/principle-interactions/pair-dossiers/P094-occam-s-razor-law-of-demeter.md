...
Both affect assumptions a caller makes about collaborator structure.

## Interaction mechanism

The screened hypothesis was: Replacing object-graph navigation with a meaningful nearby operation removes assumptions about nested ownership and layout. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Replacing object-graph navigation with a meaningful nearby operation removes assumptions about nested ownership and layout.
