# Convention over Configuration ↔ Data-Driven Design
...
Both affect representation of a dominant case and its regular exceptions.

## Interaction mechanism

The screened hypothesis was: Convention handles the stable default; a small typed table can encode the remaining inspectable variations without repeated control flow. Targeted research did not support it as a general interaction beyond project-specific circumstances.
...
**Candidate hypothesis:** Convention handles the stable default; a small typed table can encode the remaining inspectable variations without repeated control flow.
...
Blind primary screen: **Independence / reject**. Blind independent screen: **Complementary / uncertain**. The research pass rejected the hypothesis rather than averaging the two screens.
