...
- Maintain the project’s standalone reference on the Rule of Three and evidence-timed abstraction.

# Ownership

- `Rule of Three.md` owns the comprehensive chapter, including limits, review guidance, and sources.
