...
- Maintain the project’s standalone reference on convention over configuration and shared defaults.

# Ownership

- `Convention over Configuration.md` owns the comprehensive chapter, including limits, review guidance, and sources.
