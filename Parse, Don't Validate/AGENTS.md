...
- Maintain the project’s standalone reference on boundary parsing into trusted domain values.

# Ownership

- `Parse, Don't Validate.md` owns the comprehensive chapter, including limits, review guidance, and sources.
