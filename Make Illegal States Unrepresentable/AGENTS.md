...
- Maintain the project’s standalone reference on representations that exclude invalid domain states.

# Ownership

- `Make Illegal States Unrepresentable.md` owns the comprehensive chapter, including limits, review guidance, and sources.
