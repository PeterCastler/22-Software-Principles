...
- Maintain the project’s standalone reference on the Unix Philosophy and focused composable tools.

# Ownership

- `Unix Philosophy.md` owns the comprehensive chapter, including limits, review guidance, and sources.
