...
- Maintain the project’s standalone reference on Occam's Razor and unsupported complexity.

# Ownership

- `Occam's Razor.md` owns the comprehensive chapter, including limits, review guidance, and sources.
