...
- Maintain the project’s standalone reference on negative code and safe complexity reduction.

# Ownership

- `Negative Code.md` owns the comprehensive chapter, including limits, review guidance, and sources.
