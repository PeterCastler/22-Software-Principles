...
- Maintain the project’s standalone reference on data-driven design and regular variation represented as data.

# Ownership

- `Data-Driven Design.md` owns the comprehensive chapter, including limits, review guidance, and sources.
