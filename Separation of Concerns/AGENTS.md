...
- Maintain the project’s standalone reference on separation of independently changing concerns.

# Ownership

- `Separation of Concerns.md` owns the comprehensive chapter, including limits, review guidance, and sources.
