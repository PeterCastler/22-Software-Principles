...
- Maintain the project’s standalone reference on YAGNI and avoiding speculative capability.

# Ownership

- `YAGNI.md` owns the comprehensive chapter, including limits, review guidance, and sources.
